...
public class RedstoneBlockRegistry extends AtbywBlocks {
    public static final Block IRON_LADDER = new IronLadderBlock(FabricBlockSettings.of(Material.METAL).breakByTool(FabricToolTags.PICKAXES).requiresTool().sounds(BlockSoundGroup.METAL).nonOpaque());
    public static final Block IRON_LADDER_PIECE = new IronLadderPieceBlock(FabricBlockSettings.of(Material.METAL).breakByTool(FabricToolTags.PICKAXES).requiresTool().sounds(BlockSoundGroup.METAL).nonOpaque());
