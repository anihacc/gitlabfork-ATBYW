...
public class AtbywProperties extends Properties {
    ...
    public static final BooleanProperty HAS_X;
    public static final BooleanProperty HAS_Z;
    public static final IntProperty LENGTH;
    public static final IntProperty LADDERS;
    ...
    static {
        ...
        HAS_X = BooleanProperty.of("x");
        HAS_Z = BooleanProperty.of("z");
        LENGTH = IntProperty.of("length", 0, 7);
        LADDERS = IntProperty.of("ladders", 0, 7);
        LADDER_PIECE = EnumProperty.of("piece", IronLadderPiece.class);
    }
}
